  ...
  return (
    <div
      ...
      className={`rounded-lg overflow-hidden mb-2  ${
        isActive
          ? 'active border-[3px] dark:border-[#656fe2]  border-[#F2F2F2] dark:bg-[#E0ECFB] bg-[#F2F2F2]'
...
export function AccordionHeader({
  ...
  return (
    <motion.div
      data-active={isActive || undefined}
      className={`group p-4 cursor-pointer transition-all font-semibold    dark:text-white text-black dark:hover:bg-[#1e2a78] hover:bg-[#F2F2F2] dark:hover:text-white hover:text-black flex justify-between items-center ${className} ${
        isActive
